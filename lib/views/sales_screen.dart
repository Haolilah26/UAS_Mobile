...
import 'package:syakirabakery_app/controllers/sales_controller.dart';
import 'package:syakirabakery_app/models/sales_model.dart';
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              style: ButtonStyle(
                backgroundColor: WidgetStatePropertyAll(Colors.pink[200]),
                foregroundColor: WidgetStatePropertyAll(Colors.black),
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  List<Sales> filteredsales =
                      sales.where((sale) => sale.issuer == 'Siti Haolilah').toList();

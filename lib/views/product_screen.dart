...
import 'package:syakirabakery_app/controllers/product_controller.dart';
import 'package:syakirabakery_app/models/product_model.dart';
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  List<Product> filteredProducts = products
                      .where((product) => product.issuer == 'Siti Haolilah')
                      .toList();
